...
class dspic33ep : public Pic{
	...
	protected:
        ...
        uint8_t read_config_byte(uint32_t addr);
        uint16_t read_userID_word(uint32_t addr);

		/*
		* DEVICES SECTION
		*    ID       NAME           	  MEMSIZE
		*/
		pic_device piclist[80] = {
            ...
            {0x1C19, "PIC24EP32GP202", 0x0057EA},
